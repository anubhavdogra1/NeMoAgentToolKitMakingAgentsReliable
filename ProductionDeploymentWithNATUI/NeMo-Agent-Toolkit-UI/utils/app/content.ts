 ...
 */
export async function loadContentFile(_filename: string): Promise<string>;
export async function loadContentFile<T>(
  _filename: string,
  _parseJson: true,
): Promise<T | null>;
export async function loadContentFile<T = string>(
  filename: string,
 ...
 */
export function loadContentFileSync(_filename: string): string;
export function loadContentFileSync<T>(
  _filename: string,
  _parseJson: true,
): T | null;
export function loadContentFileSync<T = string>(
  filename: string,
  parseJson: boolean = false,
): T | string | null {
  try {
